...
import com.example.counterfeit.databinding.ActivityHomeBinding;
...
public class home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_COMPLAINT) {
            ...
            Intent i =new Intent(getApplicationContext(),sentspam.class);
            startActivity(i);
        } else if (id == R.id.nav_productdetails) {
            Intent i = new Intent(getApplicationContext(), viewproductdetails.class);
            startActivity(i);
        }
