                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    com_date[i] = u.getString("complaint_date");
                                    reply[i] = u.getString("reply");
                                    replydate[i] = u.getString("replydate");


                                }
                                li.setAdapter(new custom_view_complaint(getApplicationContext(), complaint, com_date, reply, replydate));//custom_view_service.xml and li is the listview object
